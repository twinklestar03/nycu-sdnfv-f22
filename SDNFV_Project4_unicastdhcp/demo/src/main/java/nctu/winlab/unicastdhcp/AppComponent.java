        ...
        public void event(NetworkConfigEvent event) {
            if ((event.type() == CONFIG_ADDED || event.type() == CONFIG_UPDATED)
                ...
                if (config != null) {
                    ...
                    h2Point = config.h2Point();
                    log.info("DHCP server is connected to `{}`, port `{}`", 
                        dhcpServer.deviceId().toString(), dhcpServer.port().toString());
                    log.info("H2 point is connected to `{}`, port `{}`", 
                        h2Point.deviceId().toString(), h2Point.port().toString());
                    ...
                    PointToPointIntent clientIntent = PointToPointIntent.builder()
                        ...
                        .filteredIngressPoint(
                            new FilteredConnectPoint(h2Point))
                        .filteredEgressPoint(
                    ...
                    log.info(
                        ...
                        h2Point.deviceId().toString(),
                        h2Point.port().toString(),
