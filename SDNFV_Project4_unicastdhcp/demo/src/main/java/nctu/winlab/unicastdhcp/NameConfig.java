...
public class NameConfig extends Config<ApplicationId> {
	...
	public static final String H2_CONNECTPOINT = "h2Location";

    @Override
    public boolean isValid() {
        return isConnectPoint(H2_CONNECTPOINT, FieldPresence.MANDATORY) && isConnectPoint(DEVICE_CONNECTPOINT, FieldPresence.MANDATORY);
    }
	...
	public ConnectPoint h2Point() {
		String connectPoint = get(H2_CONNECTPOINT, null);
		return connectPoint != null ? ConnectPoint.deviceConnectPoint(connectPoint) : null;
	}
}
